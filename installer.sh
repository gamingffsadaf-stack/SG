...
#=======================#
clear
typewriter "${CYAN}${BOLD}  _________                  __.__  __      ________    _____      _____  .___ _______    ________  ${RESET}" 0.002
typewriter "${CYAN}${BOLD} /   _____/____    ____     |__|__|/  |_   /  _____/   /  _  \    /     \ |   |\      \  /  _____/  ${RESET}" 0.002
typewriter "${CYAN}${BOLD} \_____  \\__  \  /    \    |  |  \   __\ /   \  ___  /  /_\  \  /  \ /  \|   |/   |   \/   \  ___  ${RESET}" 0.002
typewriter "${CYAN}${BOLD} /        \/ __ \|   |  \   |  |  ||  |   \    \_\  \/    |    \/    Y    \   /    |    \    \_\  \ ${RESET}" 0.002
typewriter "${CYAN}${BOLD}/_______  (____  /___|  /\__|  |__||__|    \______  /\____|__  /\____|__  /___\____|__  /\______  / ${RESET}" 0.002
typewriter "${CYAN}${BOLD}        \/     \/     \/\______|                  \/         \/         \/            \/        \/  ${RESET}" 0.002
typewriter "${YELLOW}-----------------------------------------------------------------------------------------------${RESET}" 0.002
typewriter "${GREEN}            ⚙️  Custom Pterodactyl Installer  |  Powered by @its_sadaf_officail${RESET}" 0.002
typewriter "${YELLOW}-----------------------------------------------------------------------------------------------${RESET}" 0.002
sleep 1
